...
def main():
    ...
    ## shutil.move("Cloud\abc.docx.enc", "abc.docx.enc") tạm thời đừng quan tâm
    ...
    publicKeyAlice = ReadKey("PublicKeyAlice.txt",' ')
    IdDocAlice = ReadKey("IdDocAlice.txt",' ')
