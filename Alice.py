...
def main():
    # Hash Doc thành Id và tạo cặp khoá public và private của Alice
    id = HashToId("abc.docx")
    publicKey, privateKey = makeKeyFilesAlice("PublicKeyAlice.txt", 512)
    ...
    WriteToFiles("IdDocAlice.txt", luuchuoi)
